...
class Dataset:
    ...
    def shuffle_data(self):
        i = np.arange(len(self.morphs))
        np.random.shuffle(i)
        self.morphs, self.ne_dicts, self.characters, self.sequence_lengths, self.character_lengths, self.labels = \
            self.morphs[i], self.ne_dicts[i], self.characters[i], self.sequence_lengths[i], self.character_lengths[i], self.labels[i]
